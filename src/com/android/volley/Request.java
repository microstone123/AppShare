...
public abstract class Request<T> implements Comparable<Request<T>> {
	 ...
	 * 超时时间
	 */
	private static final int INITIAL_TIMEOUTMS = 10 * 1000;
	 ...
	 * 退避乘数政策
	 */
	private static final float BACKOFF_NUM = 1.0f;
	...
	public Request(int method, String url, Response.ErrorListener listener) {
		...
		setRetryPolicy(new DefaultRetryPolicy(INITIAL_TIMEOUTMS, MAXIMUM_RETRIES, BACKOFF_NUM));
