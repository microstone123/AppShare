 ...
 * 
 */
public class TestPullListView extends ListView implements OnScrollListener, OnClickListener {
	// 下拉ListView枚举所有状态
...
//	private TextView mLastUpdateTextView;// 更新事件（mHeadView）
	...
	public TestPullListView(Context context) {
		super(context, null);
		initDragListView(context);
	}

	public TestPullListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initDragListView(context);
	}
...
//		mHeadViewHeight = mHeadView.getMeasuredHeight();
		...
		addHeaderView(mHeadView);// 将初始好的ListView add进拖拽ListView
