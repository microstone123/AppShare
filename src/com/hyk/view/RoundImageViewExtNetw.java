 ...
 * @author Alan
 */
public class RoundImageViewExtNetw extends NetworkImageView {
	...
	public RoundImageViewExtNetw(Context context) {
		super(context);
		mContext = context;
	}

	public RoundImageViewExtNetw(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		setCustomAttributes(attrs);
	}

	public RoundImageViewExtNetw(Context context, AttributeSet attrs, int defStyle) {
