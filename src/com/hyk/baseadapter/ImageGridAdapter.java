...
import com.hyk.photo.BitmapCache;
import com.hyk.photo.BitmapCache.ImageCallback;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if ((BimpUtils.drr.size() + selectTotal) < 6) {
				...
				} else if ((BimpUtils.drr.size() + selectTotal) >= 6) {
