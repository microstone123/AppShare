...
//	protected DisplayImageOptions options; // DisplayImageOptions是用于设置图片显示的类
	...
	public AttentionUserAdapter(Context context, List<AttentionInfo> apps, int relation,String regId) {
		try {
...
//		imageLoader.displayImage(appInfoList.getHeadPic(), listItemView.the_attention_img, options);
