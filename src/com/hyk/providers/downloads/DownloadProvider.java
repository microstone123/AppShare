...
package com.hyk.providers.downloads;
...
public final class DownloadProvider extends ContentProvider {
	...
	private static final String[] sAppReadableColumnsArray = new String[] { Downloads._ID,
			Downloads.COLUMN_APP_DATA, Downloads._DATA, Downloads.COLUMN_MIME_TYPE,
			Downloads.COLUMN_VISIBILITY, Downloads.COLUMN_DESTINATION, Downloads.COLUMN_CONTROL,
			...
			Downloads.COLUMN_TOTAL_BYTES, Downloads.COLUMN_CURRENT_BYTES, Downloads.COLUMN_TITLE,
			Downloads.COLUMN_DESCRIPTION, Downloads.COLUMN_URI,
			Downloads.COLUMN_IS_VISIBLE_IN_DOWNLOADS_UI, Downloads.COLUMN_FILE_NAME_HINT,
		...
		private void createDownloadsTable(SQLiteDatabase db) {
			try {
				...
				db.execSQL("CREATE TABLE " + DB_TABLE + "(" + Downloads._ID
						+ " INTEGER PRIMARY KEY AUTOINCREMENT," + Downloads.COLUMN_URI + " TEXT, "
						+ Constants.RETRY_AFTER_X_REDIRECT_COUNT + " INTEGER, "
						+ Downloads.COLUMN_APP_DATA + " TEXT, " + Downloads.COLUMN_NO_INTEGRITY
						+ " BOOLEAN, " + Downloads.COLUMN_FILE_NAME_HINT + " TEXT, "
						+ Constants.OTA_UPDATE + " BOOLEAN, " + Downloads._DATA + " TEXT, "
						+ Downloads.COLUMN_MIME_TYPE + " TEXT, " + Downloads.COLUMN_DESTINATION
						+ " INTEGER, " + Constants.NO_SYSTEM_FILES + " BOOLEAN, "
						+ Downloads.COLUMN_VISIBILITY + " INTEGER, " + Downloads.COLUMN_CONTROL
						+ " INTEGER, " + Downloads.COLUMN_STATUS + " INTEGER, "
						...
						+ Downloads.COLUMN_COOKIE_DATA + " TEXT, " + Downloads.COLUMN_USER_AGENT
						+ " TEXT, " + Downloads.COLUMN_REFERER + " TEXT, "
						+ Downloads.COLUMN_TOTAL_BYTES + " INTEGER, "
						+ Downloads.COLUMN_CURRENT_BYTES + " INTEGER, " + Constants.ETAG
	...
	public Uri insert(final Uri uri, final ContentValues values) {
		...
		if (Constants.LOGVV) {
			...
			if (filteredValues.containsKey(Downloads.COLUMN_OTHER_UID)) {
				Log.v(Constants.TAG,
						"other UID " + filteredValues.getAsInteger(Downloads.COLUMN_OTHER_UID));
			}
		}
	...
	private Cursor queryRequestHeaders(SQLiteDatabase db, Uri uri) {
		...
		Cursor cursor = db.query(Downloads.RequestHeaders.HEADERS_DB_TABLE, projection, where,
				null, null, null, null);
