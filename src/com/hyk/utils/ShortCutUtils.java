 ...
 * @Description: TODO(桌面快捷方式有关的工具类)
 * @author linhaishi
 * @date 2013-8-23 下午12:05:22
 * 
 */
public class ShortCutUtils {
	...
	public static void addShortCut(Context context, String shortCutName, int resourceId, Class<?> cls) {
		...
		shortCutIntent.putExtra(Intent.EXTRA_SHORTCUT_INTENT, new Intent().setAction(Intent.ACTION_MAIN).addCategory(Intent.CATEGORY_LAUNCHER)
