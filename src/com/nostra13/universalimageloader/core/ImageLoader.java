...
public class ImageLoader {
	...
	public void displayImage(String uri, ImageAware imageAware) {
		displayImage(uri, imageAware, null, null, null, null, null);
	}
	...
	public void displayImage(String uri, ImageAware imageAware, ImageLoadingListener listener) {
		displayImage(uri, imageAware, null, listener, null, null, null);
	}
	...
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options) {
		displayImage(uri, imageAware, options, null, null, null, null);
	}
	...
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
		...
		displayImage(uri, imageAware, options, listener, null, null, null);
	}
	 ...
	 */
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
			ImageLoadingListener listener, ImageLoadingProgressListener progressListener,Integer w,Integer h) {
		checkConfiguration();
		if (imageAware == null) {
...
//		bitmapList = new ArrayList<Bitmap>();
	...
	public void displayImage(String uri, ImageView imageView) {
		displayImage(uri, new ImageViewAware(imageView), null, null, null, null, null);
	}
	 ...
	 *             if passed <b>imageView</b> is null
	 */
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options,int w,int h) {
		displayImage(uri, new ImageViewAware(imageView), options, null, null,w,h);
	}
	
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options) {
		displayImage(uri, new ImageViewAware(imageView), options, null, null,null,null);
	}
	...
	public void displayImage(String uri, ImageView imageView, ImageLoadingListener listener) {
		displayImage(uri, new ImageViewAware(imageView), null, listener, null, null, null);
	}
	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options,
		...
		displayImage(uri, new ImageViewAware(imageView), options, listener, progressListener, null, null);
	}
	...
	public void loadImage(String uri, ImageSize targetImageSize, DisplayImageOptions options,
		...
		displayImage(uri, imageAware, options, listener, progressListener, null, null);
	}
